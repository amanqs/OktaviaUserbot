...
async def create_botlog(client):
    ...
    try:
        ...
        print("Oktavia").warning(
            "var LOG_GROUP kamu belum di isi. Buatlah grup telegram dan masukan bot @MissRose_bot lalu ketik /id Masukan id grup nya di var BOTLOG_CHATID"
        )
