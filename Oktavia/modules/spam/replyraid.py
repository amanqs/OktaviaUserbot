...
#              return #remove # to enable this
        if int(id) in VERIFIED_USERS:
            text = "ERORR, soalnya ini pembuatku"
            await e.reply_text(text)
        elif int(id) in SUDO_USERS:
            text = "orang itu bagian dari devs saya."
            await e.reply_text(text)
        else:
            fname = ok.first_name
