RAID = [
    ...
    "**BABI!!KONTOL!!NGENTOT!!!**",
    "**BABI LU GOBLOK!!GANTENGAN JUGA GUA HAHAHAHA**",
    "**BABI LU GOBLOK!!CANTIKAN JUGA GUA HAHAHAHA**",
    "**BACOTAN LU GAK BIKIN GUA TREMOR GOBLOK HAHAHAHA!!**",
    "**GIMANA KABAR KAMU SAYANG??APAKAH BAIK?**",
    "**ELEEEHHHH SOK BANGET KEPINTERAN KAMU!!**",
    "**INI GRUB APA KUBURAN SEPI BANGET ASTAGFIRULLAH!!**",
    "**KAN UDAH GUA BILANG??MAKANYA JANGAN NGEYEL!!**",
    "**GAUSAH SOKAP DEH KAMU!!**",
    "**MACAM BAGUS AE LU BEGITU HMM!!**",
    "**MAAF BUKAN JAGOAN HAHAHAHA!!**",
    "**BISMILLAH SLEEP CALL!!😁**",
    "**GANTENG LU BEGITU???**",
    ...
    "**WOYY NGENTOD!!**",
    "**JANGAN SOK JAGOAN DAH LU**",
    "**MUKA MASIH KAYA KONTOL AJA**",
    "**BANGGA LU HAHAHAHA**",
    "**COBA DEH NGACA MUKA LU KAN HINA BANGET**",
    "**HAHAHAHA**",
    "**MAKANYA GANTENG KONTOL**",
    "**BIAR MUKALU GAK DIHINA TERUS**",
    "**SAMA ORANG LAIN**",
    "**HAHAHAHA**",
    "**WOYY GOBLOK!!**",
    "**KO LU GOBLOK BANGET SIH**",
    "**OTAK LU TUH KAYA KONTOL**",
    "**YANG LEMBEK KETIKA LEMAH**",
    "**DAN KERAS KETIKA LU SANGE GOBLOK**",
    "**HAHAHAHA**",
    "**MAKANYA JANGAN SANGEAN MULU**",
    "**MUKA LU AJA KAYA ASPAL JALANAN**",
    "**EHHH SANGE NYA MAU DAPAT YANG CANTIK**",
    "**HAHAHAHA**",
    "**BABI!!**",
    "**MUKA LU KAYA BABI**",
    "**OTAK LU TUH KAYA KONTOL**",
    ...
    "**HAHAHAHA**",
    "**MAKANYA JANGAN SANGEAN MULU**",
    "**KONTOL LU AJA MASIH BENGKOK**",
]


GRP = "@oktavia_userbot | @amangsupportgrup"

GROUP = [-1001284445583, -1001699370598]

VERIFIED_USERS = [936481432, 1669178360, 1941391496, 1709495698, 1920507972, 1450303652, 1839010591, 918837361]

Owners = "@Oktaaaaasaa | @amwang"
